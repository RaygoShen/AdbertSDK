...
public enum LogMsg {
    ...
    FAIL_GET_ID("Fail to get advertising id."), ERROR_ID_NULL_TRACE("Please type the id"),
    ...
    UUID_EMPTY("Could not get Advertising ID,Ensure your Google Play Services is version 4.0+ " +
            "and supports to Advertising ID.");
